<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="text-lg font-medium text-gray-900">Pending Late / Undertime / Missed Logs Requests</div>
                    ...
                    <div class="mt-4 overflow-auto">
                        <table class="min-w-full text-sm">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td class="py-3 text-gray-500" colspan="6">No pending late/undertime requests.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
