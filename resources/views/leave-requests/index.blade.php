<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <h3 class="text-lg font-medium text-gray-900">{{ __('File Absence') }}</h3>

                <form method="POST" action="{{ route('leave-requests.store') }}" class="mt-4 space-y-4">
                    @csrf
                    <div>
                        <x-input-label for="leave_type" :value="__('Type')" />
                        <x-text-input id="leave_type" name="leave_type" type="text" class="mt-1 block w-full" value="Absent" />
